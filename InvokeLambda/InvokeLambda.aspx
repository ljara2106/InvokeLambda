...
<head runat="server">
    ...
    <script>
        function showProcessing() {
            document.getElementById('btnInvokeLambda').disabled = false;
...
<body>
    <div class="container">
        ...
        <form id="form1" runat="server">
            ...
            <div class="form-group">
            <asp:Button ID="btnInvokeLambda" runat="server" CssClass="btn-invoke" Text="Invoke Lambda" OnClientClick="showProcessing();" OnClick="btnInvokeLambda_Click" />
        </div>
        </form>
